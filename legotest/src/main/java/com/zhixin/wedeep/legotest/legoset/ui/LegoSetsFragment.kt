...
import com.zhixin.wedeep.common.ui.GridSpacingItemDecoration
...
import com.zhixin.wedeep.common.util.ConnectivityUtil
import com.zhixin.wedeep.legotest.R
import com.zhixin.wedeep.legotest.databinding.FragmentLegosetsBinding
...
class LegoSetsFragment : Fragment(), Injectable {
    ...
    private fun subscribeUi(adapter: LegoSetAdapter) {
        viewModel.legoSets.observe(viewLifecycleOwner, Observer {
