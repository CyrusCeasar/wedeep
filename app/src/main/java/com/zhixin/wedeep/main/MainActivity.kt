...
import com.zhixin.wedeep.legotest.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.navigationView.menu.getItem(2).setOnMenuItemClickListener{
            ARouter.getInstance().build("/legotest/test/LegoTest")
                    .withObject("key4", LegoTheme(1,"testName",0))
                    .navigation()
            true
        }
    }
